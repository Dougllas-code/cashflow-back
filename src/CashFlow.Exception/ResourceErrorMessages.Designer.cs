...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Service bus currently unavailable.
        /// </summary>
        public static string SERVICE_BUS_UNAVAILABLE {
            get {
                return ResourceManager.GetString("SERVICE_BUS_UNAVAILABLE", resourceCulture);
            }
        }
